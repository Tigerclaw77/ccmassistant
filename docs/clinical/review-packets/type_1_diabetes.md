...
- Canonical ID: `type_1_diabetes`
- Bank ID: `ccm-bank.type_1_diabetes`
...
- Clinical content groups: type_1_diabetes__kidney_complication
...
- Activation: clinical_content_group
- Clinical content groups: type_1_diabetes__ophthalmic_complication, type_1_diabetes__proliferative_retinopathy, type_1_diabetes__proliferative_retinopathy_macular_edema
...
- Activation: clinical_content_group
- Clinical content groups: type_1_diabetes__foot_ulcer
...
- Activation: clinical_content_group
- Clinical content groups: type_1_diabetes__ketoacidosis
