...
- Canonical ID: `chronic_heart_failure`
- Bank ID: `ccm-bank.chronic_heart_failure`
...
| 20 | `ccm.chf.rapid_weight_gain` | Have you gained two or more pounds overnight or five pounds in one week? | recommended | yes | intake, monthly_checkin, care_plan_review, annual_review | no | 1 | no | Reuses an established CCM question whose wording and intent fit this condition bank. |
| 30 | `ccm.chf.swelling_change` | Is swelling in your feet, legs, or abdomen new or worse? | recommended | yes | intake, monthly_checkin, care_plan_review, annual_review | no | 1 | no | Reuses an established CCM question whose wording and intent fit this condition bank. |
| 40 | `ccm.symptom.shortness_of_breath` | Are you having shortness of breath? | recommended | yes | intake, monthly_checkin, care_plan_review, annual_review | no | 9 | no | Reuses an established CCM question whose wording and intent fit this condition bank. |
| 50 | `ccm.cardiac.chest_discomfort` | Have you had new or worsening chest pressure or discomfort? | recommended | yes | intake, monthly_checkin, care_plan_review | yes | 3 | yes | Screens for a potentially urgent cardiac symptom. |
...
| 90 | `ccm.bp.latest_systolic` | What was your most recent systolic blood pressure reading? | optional | no | intake, monthly_checkin, care_plan_review, annual_review | no | 11 | no | Reuses an established CCM question whose wording and intent fit this condition bank. |
...
- `ccm.chf.rapid_weight_gain`: Have you gained two or more pounds overnight or five pounds in one week?
- `ccm.chf.swelling_change`: Is swelling in your feet, legs, or abdomen new or worse?
...
- `ccm.chf.rapid_weight_gain`: Reuses an established CCM question whose wording and intent fit this condition bank.
- `ccm.chf.swelling_change`: Reuses an established CCM question whose wording and intent fit this condition bank.
