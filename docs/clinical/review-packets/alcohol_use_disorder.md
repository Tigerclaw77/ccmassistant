...
- Canonical ID: `alcohol_use_disorder`
- Bank ID: `ccm-bank.alcohol_use_disorder`
...
| 80 | `ccm.substance.withdrawal_red_flag` | Are you having severe shaking, confusion, hallucinations, or a seizure while cutting down or stopping? | recommended | yes | intake, monthly_checkin, care_plan_review | yes | 2 | yes | Screens for potentially dangerous withdrawal symptoms. |
| 90 | `ccm.substance.treatment_access` | Have you had trouble getting counseling, recovery support, or prescribed treatment? | recommended | yes | intake, monthly_checkin, care_plan_review | yes | 3 | no | Identifies access barriers to ongoing substance-use treatment. |
...
- `ccm.substance.withdrawal_red_flag` (2 banks): Are you having severe shaking, confusion, hallucinations, or a seizure while cutting down or stopping?
...
- `ccm.substance.withdrawal_red_flag`: Are you having severe shaking, confusion, hallucinations, or a seizure while cutting down or stopping?
...
- `ccm.substance.withdrawal_red_flag` (urgent): Are you having severe shaking, confusion, hallucinations, or a seizure while cutting down or stopping?
...
- `ccm.substance.withdrawal_red_flag`: Screens for potentially dangerous withdrawal symptoms.
