...
- Canonical ID: `essential_tremor`
- Bank ID: `ccm-bank.essential_tremor`
...
| 60 | `ccm.neuro.balance_change` | Has your balance become worse since the last review? | recommended | yes | intake, monthly_checkin, care_plan_review | yes | 10 | no | Detects neurologic functional decline and increased fall risk. |
| 70 | `ccm.tremor.daily_tasks` | Is tremor making eating, drinking, writing, or dressing harder? | recommended | yes | intake, monthly_checkin, care_plan_review | yes | 1 | no | Measures functional impact of tremor. |
| 80 | `ccm.tremor.medication_effect` | If you use treatment for tremor, is it wearing off or causing a problem? | recommended | yes | intake, monthly_checkin, care_plan_review | yes | 1 | no | Assesses treatment effectiveness and adverse effects without assuming medication use. |
...
- `ccm.tremor.daily_tasks`: Is tremor making eating, drinking, writing, or dressing harder?
- `ccm.tremor.medication_effect`: If you use treatment for tremor, is it wearing off or causing a problem?
...
- `ccm.tremor.daily_tasks`: Measures functional impact of tremor.
- `ccm.tremor.medication_effect`: Assesses treatment effectiveness and adverse effects without assuming medication use.
