...
- Canonical ID: `sarcoidosis`
- Bank ID: `ccm-bank.sarcoidosis`
...
| 100 | `ccm.symptom.shortness_of_breath` | Are you having shortness of breath? | recommended | yes | intake, monthly_checkin, care_plan_review, annual_review | no | 9 | no | Reuses an established CCM question whose wording and intent fit this condition bank. |
