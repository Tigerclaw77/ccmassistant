...
- Canonical ID: `systemic_lupus_erythematosus`
- Bank ID: `ccm-bank.systemic_lupus_erythematosus`
...
| 90 | `ccm.lupus.organ_concern` | Has a clinician told you there is new organ involvement from lupus? | recommended | yes | intake, monthly_checkin, care_plan_review | yes | 1 | no | Captures confirmed management-changing organ involvement without asking the patient to diagnose it. |
...
- `ccm.lupus.organ_concern`: Has a clinician told you there is new organ involvement from lupus?
...
- `ccm.lupus.organ_concern`: Captures confirmed management-changing organ involvement without asking the patient to diagnose it.
